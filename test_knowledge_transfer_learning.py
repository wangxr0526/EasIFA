...
from data_loaders.enzyme_rxn_dataloader import AugEnzymeReactionDataset, EnzymeReactionDataset, EnzymeReactionSiteTypeDataset,  enzyme_rxn_collate_extract
...
if __name__ == '__main__':
    ...
    parser.add_argument('--structure_path',
                        type=str,
                        default='dataset/mcsa_fine_tune/structures')
