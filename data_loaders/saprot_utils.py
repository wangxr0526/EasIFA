'''
accept from https://github.com/westlake-repl/SaProt.git
'''
...
if __name__ == "__main__":
    parsed_seqs = get_struc_seq('../foldseek_bin/foldseek', '../dataset/ec_site_dataset/structures/alphafolddb_download/AF-P15650-F1-model_v4.pdb', chains=['A'],process_id='AF-P15650-F1-model_v4')['A'] 
